...
namespace Quản_lý_Sinh_viên.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        {
            var myDbContext = _context.SinhViens.Include(s => s.Khoa);
        ...
        public async Task<IActionResult> Create([Bind("MaSV,HoTen,MaKhoa")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaSV,HoTen,MaKhoa")] SinhVien sinhVien)
        {
            if (id != sinhVien.MaSV)
            {
                return NotFound();
